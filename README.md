...
using React Router. See [my article on Medium](https://medium.com/@shyanmingperng/web-application-routing-217b92770a1)
Since we are interested in centralized route configuration, we make use of the
[react-router-config](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-config),
which is currently in alpha, but appears to work for our example.
